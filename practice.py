...
def player_animation():
    ...
    # play walking animation if player on the ground
    # display the jump surface when player is not on the ground
...
game_instruction = test_font.render('Press Space Bar to Begin', False, (111,196,169))
